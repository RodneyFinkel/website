...
def display_tech_stack():
    ...
    projects = [
        ...
        
        {
            ...
            "description": "FastAPI exposing three endpoints: LangGraph Multi-Agent Orchestrator, Async Semantic Web Researcher with ChromaDB persistence, and ReAct NL2SQL + Filesystem Agent. Includes Swagger UI for easy testing.",
